...
i18n.use(initReactI18next).init({
  resources: {
    ar: { common: common_ar, auth: auth_ar, dashboard: dashboard_ar, survey: survey_ar, public: public_ar, admin: admin_ar },
    en: { common: common_en, auth: auth_en, dashboard: dashboard_en, survey: survey_en, public: public_en, admin: admin_en },
  },
  lng: "ar",
  fallbackLng: "en",
  defaultNS: "common",
  ns: ["common", "auth", "dashboard", "survey", "public", "admin"],
